...
/***/ function(module, exports, __webpack_require__) {
	...
	var _io = __webpack_require__(195);
	...
	window.socket = (0, _io2.default)(store);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _creators = __webpack_require__(196);
	...
	exports.default = function (store) {
		...
		socket.on('newMessage', function (message) {
			...
			store.dispatch((0, _creators.receiveMessage)(message));
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		...
		switch (action.type) {
			case _types.RECEIVE_MESSAGE:
			case _types.SEND_MESSAGE:
				return _extends({}, state, {
					messages: (0, _message2.default)(state.messages, action)
				});
			default:
				return state;
		}
	...
	var App = function App(props) {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement('div', { className: 'col col-sm left' }),
				_react2.default.createElement(
					'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BoardRow = __webpack_require__(202);
	...
	var Board = function Board(props) {
		...
		for (var i = 0; i < size; i++) {
			rows.push(_react2.default.createElement(_BoardRow2.default, { key: 'row-' + i, size: size }));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BoardTile = __webpack_require__(203);
	...
	var BoardRow = function BoardRow(props) {
		...
		var tiles = [];
		for (var i = 0; i < size; i++) {
			tiles.push(_react2.default.createElement(_BoardTile2.default, { key: 'tile-' + i }));
		}
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
		return {
			onSubmit: function onSubmit(message) {
				dispatch((0, _creators.sendMessage)(message));
			}
		};
	};
